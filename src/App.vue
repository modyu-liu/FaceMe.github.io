...
<template>
  ...
  <p style="text-align: center; font-size: 1.5em;">
      <a href="http://arxiv.org/abs/2501.05177" target="_blank">[Paper]</a>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div class="row">
    ...
    <ImgComparisonSlider>
      <img
        slot="first"
        style="width: 100%"
        src="/pair_result/hinton/lq_2.png"
      />
      <img
        slot="second"
        style="width: 100%"
        src="/pair_result/hinton/sr_2.png"
      />
    </ImgComparisonSlider>
    <ImgComparisonSlider>
      <img
  ...
  <div class="row">
    ...
    <ImgComparisonSlider>
      <img
        slot="first"
        style="width: 100%"
        src="/pair_result/feifei/lq_1.png"
      />
      <img
        slot="second"
        style="width: 100%"
        src="/pair_result/feifei/sr_1.png"
      />
    </ImgComparisonSlider>
  </div>
  <!-- <div class="row">
